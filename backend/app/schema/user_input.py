...
from app.utils.city_tier import tier_1_cities, tier_2_cities
...
class UserInput(BaseModel):
    ...
    income_lpa: Annotated[float,
                          Field(..., ge=0, description='Annual salary of the user in lpa')]
    ...
    # city processing(normalized city), bmi, lifestyle_risk, age_group, city_tier
